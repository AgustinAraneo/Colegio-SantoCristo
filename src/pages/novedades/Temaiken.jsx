        ...
        <div className='h-full bg-slate-100 bg-fixed bg-center bg-no-repeat bg-cover bg-fondo'>
            ...
            <div className="w-full flex justify-center my-8">
                ...
                >
                    ...
                    <div>
                        <img src="/images/temaiken/2a.jpeg" alt="Imagen 1" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/2b.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/2c.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/2d.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/2doo.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/ganzos.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/tortuga.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/medusa.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
                        <img src="/images/temaiken/flamengos.jpeg" alt="Imagen 2" className="h-[700px]" />
                    </div>
                    <div>
