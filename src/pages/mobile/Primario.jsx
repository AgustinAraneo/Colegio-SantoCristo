    ...
    <div className='bg-slate-100'>
      ...
      <div>
        ...
        <div className='flex flex-col justify-center gap-8 mb-[2rem]'>
          <img src='/images/tarjeta-primaria-izquierda.png' className='w-[70%] h-[20%] transition duration-500 hover:scale-105 mx-auto'></img>
          <img src='/images/tarjeta-horarios-primaria.png' className='w-[70%] h-[20%] transition duration-500 hover:scale-105 mx-auto'></img>
          <img src='/images/tarjeta-primaria-derecha.png' className='w-[70%] h-[20%] transition duration-500 hover:scale-105 mx-auto'></img>
        </div>
      </div>
      ...
      <div className='flex justify-center'>
        <div className=' bg-green-600 h-[15rem] mb-[1rem] transition duration-500 hover:scale-105' style={{ width: '70%' }}>
          <p className='pt-2 ml-4 text-2xl font-bold text-white font-Montserrat'>Inscripción Colegio <br /> Santo Cristo<br /> Nivel Primario
          </p>
