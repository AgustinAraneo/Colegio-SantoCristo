  ...
  return (
    <div className='bg-slate-100'>
      ...
      <div className='container font-Montserrat'>
        <h1 className='text-5xl text-green-800 font-bold pb-5 font-Montserrat mt-2 text-center'>
        ...
        <p className='border-b-2 border-green-800 mt-4 w-[95%] mx-auto'></p>
        <div className='grid grid-cols-1 gap-4 mt-10 mb-10'>
          {docentes.map((docente) => (
            <div key={docente.name} className='relative'>
              <img src={docente.image} className="w-[90%] h-[400px] rounded shadow-2xl mx-auto" />
              <p className='absolute bottom-0 left-0 bg-white bg-opacity-90 py-1 px-2 text-center font-medium w-[90%] ml-[5%]'>
                {docente.name}
              </p>
            </div>
          ))}
