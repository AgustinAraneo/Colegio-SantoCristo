...
const Historia = () => {
  return (
    <div>
      <Header />
      <section className="bg-gray-100 py-10 font-Montserrat">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-green-700 mb-3 w-[90%] mx-auto">Historia del Colegio</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="w-[90%] mx-auto text-justify text-sm">
              <p className="mb-4">
            ...
            <div>
              <img src="/images/foto-primaria.jpg" alt="Historia del Colegio" className="w-[90%] mx-auto" />
            </div>
          </div>
        </div>
      </section>
