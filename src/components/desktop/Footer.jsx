  ...
  return (
    <div className='bg-green-800 w-full h-[13rem]'>
      <div className='flex flex-auto gap-[5rem] justify-center pt-[3rem] text-white font-Roboto-Light text-lg font-bold'>
        <div><span className='rounded-r-full shadow-2xl bg-green-footer'>Comunidad Educativa Santo Cristo</span>
          <div className='flex flex-auto mt-3 text-[1.2rem]'><span className='mt-[0.1rem]'><BsCheck2Circle /></span><span className='ml-2 text-base font-normal'>Mas de 60 años brindando educacion de primera...</span></div>
