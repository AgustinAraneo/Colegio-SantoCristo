...
const Header = () => {
    ...
    return (
      <header className="flex items-center justify-between p-2 bg-gradient-to-tr from-green-500 to-green-900 border-red-900 border-b-2">
        <div className="font-bold text-white flex flex-auto "><img className='w-[4.5rem] h-[5.5rem] ml-[2rem] pt-2' src='https://i.ibb.co/k2ckb7p/Logo-escuela.png' /><span className='ml-[2rem] mt-[1.75rem] font-Roboto-Regular font-light text-2xl'>Comunidad Santo Cristo</span></div>
