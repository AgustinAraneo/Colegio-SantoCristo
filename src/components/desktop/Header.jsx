    ...
    <header className="flex items-center justify-between p-2 bg-green-800 border-b-2 border-red-900 font-Montserrat ">
      <div className="flex flex-auto font-bold text-white ">
        <img
          ...
          alt="Logo"
        />
        <span className="2xl:ml-[2rem] ml-2 mt-[1.25rem] font-Josefin font-semibold text-lg xl:text-xl 2xl:text-2xl text-center">
      ...
      <nav className="flex flex-auto justify-end 2xl:mr-[1rem] font-Roboto-Medium 2xl:text-[0.95rem] xl:text-[0.8rem] text-[0.7rem]">
        ...
        >
          <button className="flex flex-auto mr-2 text-white c hover:text-gray-400">
            NIVELES
        ...
        >
          <button className="flex flex-auto text-white transition duration-500 hover:text-gray-400">
            CONTACTO
            <span className="text-2xl">
              <RiArrowDownSLine />
            </span>
      ...
      <a
        className="test3 font-Montserrat m-2 2xl:text-[15px] xl:text-md text-xs"
        href="/Noticias"
      >
        NOVEDADES
      </a>
      <a
        className="test2 font-Montserrat m-2 2xl:text-[15px] xl:text-md text-xs"
        href="/Admision"
      >
        INSCRIPCIÓN 2025
      </a>
